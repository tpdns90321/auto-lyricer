...
class TestTranscription:
    ...
    def test_transcription_with_different_extensions(self):
        ...
        srt_transcription = Transcription(
            content=content, extension=SubtitleExtension.SRT
        )
        vtt_transcription = Transcription(
            content=content, extension=SubtitleExtension.VTT
        )
